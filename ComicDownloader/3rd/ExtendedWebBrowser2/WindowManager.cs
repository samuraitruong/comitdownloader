...
namespace ExtendedWebBrowser2
{
  ...
  class WindowManager
  {
    ...
    public ExtendedWebBrowser New(bool navigateHome)
    {
      ...
      page.Text = ComicDownloader.Properties.Resources.DefaultBrowserTitle;
    ...
    void WebBrowser_DocumentTitleChanged(object sender, EventArgs e)
    {
      ...
      {
        documentTitle = ComicDownloader.Properties.Resources.DefaultBrowserTitle;
      }
